...
class Market1501(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        ...
        query = self._process_valdir(self.query_dir, relabel=False)
        gallery = self._process_valdir(self.gallery_dir, relabel=False)
    ...
    def _process_valdir(self, dir_path, relabel=False):
        img_paths = glob.glob(osp.join(dir_path, '*.jpg'))
